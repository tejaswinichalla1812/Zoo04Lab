 ...
 * Abstract - don't make a general animal - only specific types.
 * 
 * @author Dr. Case
 */
public abstract class Animal {
    ...
    /**
     * Every animal has a name. Class variable name is
     * not private, but protected - only subclasses can use it.
     */
